This is an example of torrent provider json file to scrape this html pages.
...
```javascript
{
    // torrent provider identifier
    "name": "cool-torrent-website",
    "fullname": "Cool Torrent Website",
    // base url of the website
    "url": "https://cool-torrent-website.io/",
    // the path to the search page ({query} is the query variable)
